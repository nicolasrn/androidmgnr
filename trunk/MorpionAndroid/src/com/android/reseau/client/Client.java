 ...
 * type : type de jeu ici crade ou classique
 * host : ip du serveur
 * port : port du serveur
 * connectiona : socket de connection au serveur de jeu
 *
 */
public class Client 
{
	...
	public Client(String pseudo, String host, String port, String type) throws NumberFormatException, UnknownHostException, IOException {
		super();
	...
	/**
	 * envoie de donnée vers le serveur lors de la connection initiale du serveur
	 */
	public void envoye()
	{
		BufferedWriter out;
		...
		try 
		{
			...
			out = new BufferedWriter(new OutputStreamWriter(connectiona.getOutputStream()));
 ...
 */
	...
	{
		return "" + pseudo + " " + type + " " + host + " " + port + " " + connectiona;
	}
}
