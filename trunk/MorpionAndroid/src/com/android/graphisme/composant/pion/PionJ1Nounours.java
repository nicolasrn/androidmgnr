...
public class PionJ1Nounours extends PionGraphique {
	
	public PionJ1Nounours(Context context) {
		super(context);
		//if (imageType1 == null)
			imageType1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.canard);
		//if (imageType1 == null)
