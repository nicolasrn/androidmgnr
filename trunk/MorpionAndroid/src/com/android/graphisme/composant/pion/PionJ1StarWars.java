...
public class PionJ1StarWars extends PionGraphique {
	
	public PionJ1StarWars(Context context) {
		super(context);
		//if (imageType1 == null)
			imageType1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.yoda);
		//if (imageType1 == null)
