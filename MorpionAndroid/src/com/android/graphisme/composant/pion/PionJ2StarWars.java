...
public class PionJ2StarWars extends PionGraphique {
	
	public PionJ2StarWars(Context context) {
		super(context);
		//if (imageType2 == null)
		//	imageType2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.imgrond);
		//if (imageType2 == null)
			imageType2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.palpatine);
	}
