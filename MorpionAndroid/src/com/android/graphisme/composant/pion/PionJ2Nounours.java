...
public class PionJ2Nounours extends PionGraphique {
	
	public PionJ2Nounours(Context context) {
		super(context);
		//if (imageType2 == null)
		//	imageType2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.imgrond);
		//if (imageType2 == null)
			imageType2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.lapin);
	}
