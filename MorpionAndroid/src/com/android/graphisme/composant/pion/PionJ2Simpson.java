...
public class PionJ2Simpson extends PionGraphique {
	
	public PionJ2Simpson(Context context) {
		super(context);
		//if (imageType2 == null)
		//	imageType2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.homersimpson);
		//if (imageType2 == null)
			imageType2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.homersimpson);
	}
